    ...
    <div className="min-h-screen bg-[#F8F4F1] flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-lg p-8 space-y-6">
        <div className="max-w-md mx-auto w-full">
          <div>
            <h1 className="text-xl font-semibold mb-2 text-primary">Confirm your email</h1>
            <p className="text-sm text-gray-600">We sent a code to {maskEmail(email)}</p>
          </div>
              ...
              <div className="flex items-center my-4">
                <label className="flex items-center cursor-pointer">
                  ...
                  <span className="text-[14px] text-[#6F6B6F]">
                    I understand that if I lose access to my email, I lose access to my wallet.
                  </span>
                </label>
              </div>
